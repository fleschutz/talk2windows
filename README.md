...
🔦 *"Windows, check [item]."*
------------------------------
Lets the computer check something. Replace [item] by: `Bitcoin rate`, `Christmas`, `CPU`, `dawn`, `day`, `DNS`, `drives`, `dusk`, `Earth` (fun), `Ether rate`, `for rain`, `for snow`, `Git version`, `headlines`, `Independence Day`, `internet connection`, `internet speed`, `moon phase`, `month`, `New Year`, `operating system`, `ping`, `recycle bin`, `Santa`, `swap space`, `tea time`, `temperature`, `Tether rate`, `time zone`, `up-time`, `VPN`, `weather`, `week`, `wind`, `year`, or `zenith`.
