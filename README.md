...
❔ *"Windows, [hotkey]"*
-----------------------
Presses a keyboard shortcut to navigate in a Browser window, replace [hotkey] by: `close tab`, `next page`, `next tab`, `previous page`, `previous tab`, `open new tab`, `open new window`, `scroll down`, `scroll to bottom`, `scroll to top`, `scroll up`, `tab 1`, `tab 2`, `tab 3`, `tab 4`, `tab 5`, or `tab 6`.
