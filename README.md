...
🔧 Installation
----------------
1. **Download Serenade** from [https://serenade.ai](https://serenade.ai/download) (it's free) and install it (choose *no plugin* and *no programming language* during installation). Close the application when finished.
