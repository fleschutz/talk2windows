...
------------------------------
Installs an application from the Microsoft Store, replace [app] by: `Discord`, `Firefox`, `Netflix`, `One Calendar`, `Paint 3D`, `Spotify`, or `VLC`. Note that the applications will be updated automatically.
