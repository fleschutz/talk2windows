...
----------------------------------
Launches the default Web browser (or opens a new tab) and lets you play a browser game. Replace [name] by: `2048`, `Agar`, `Catan Universe`, `Chess`, `Cube`, `Pacman`, `Santa Tracker`, `Slither`, `Tetris`, `TicTacToe`, `Tower`, or `War Brokers`. When finished say: *"Windows, close [name] browser"* to close the Web browser.
