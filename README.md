TALK 2 WINDOWS
==============
Control Windows by using your voice. Required is Windows 10 or later, microphone and loudspeaker, the Serenade application (free), and the PowerShell scripts in this repository.
