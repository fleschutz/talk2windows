...
Most voice commands follow the simple scheme: *&lt;wake word&gt; &lt;verb&gt; &lt;subject&gt;*. The following voice commands are supported: (if wake word "Windows" is used)
...
---------------------------------------
Inserts a character at the current text cursor position. Replace &lt;char&gt; with: `at`, `backslash`, `copyright`, `Dollar`, `Euro`, `hashtag`, `Pound`, `slash`, `trademark`, `underscore`, or `Yen`.
