...
🔧 Installation
----------------
1. **Download Serenade** from: [https://serenade.ai](https://serenade.ai/download) and install it (it's free). Choose *no plugin* and *no programming language* during installation and close the application when finished.
