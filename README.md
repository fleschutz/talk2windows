...
---------------------------------------
Inserts a character at the current text cursor position. Replace &lt;char&gt; with: `at`, `backslash`, `copyright`, `Dollar`, `Euro`, `hashtag`, `minus`, `plus`, `Pound`, `slash`, `trademark`, `underscore`, or `Yen`.
