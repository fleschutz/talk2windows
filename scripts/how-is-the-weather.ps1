...
try {
	...
	& "$PSScriptRoot/_reply.ps1" "We have $tempC degrees celsius, $($Precip)mm rain, $($Humidity)% humidity, $($WindSpeed)km/h wind from $WindDir with $($Clouds)% clouds and $($Visib)km visibility."
	exit 0 # success
} catch {
